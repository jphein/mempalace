...
MemPalace provides 37 tools through the [Model Context Protocol (MCP)](https://modelcontextprotocol.io/), giving any MCP-compatible AI full read/write access to your palace.
...
Now your AI has all 37 tools available. Ask it anything:
