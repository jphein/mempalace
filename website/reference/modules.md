...
│   ├── mcp_server.py          ← MCP server (37 tools)
...
JSON-RPC over stdin/stdout. Implements the MCP protocol with 37 tools covering palace read/write, drawer CRUD, knowledge graph, navigation, tunnels, agent diary, and system operations. Includes the Memory Protocol and AAAK Spec in status responses.
