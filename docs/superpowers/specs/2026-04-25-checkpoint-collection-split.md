...
- **Promoted by:** Cat 9 A/B report (local artifact, `/tmp/cat9-ab/REPORT.md`), 2026-04-25 — kind=content delivers ~3 tokens vs 632 for kind=all on the canonical 151K palace. Over-fetch + post-filter is structurally inadequate; checkpoints must be removed from the searchable corpus, not filtered out of it.
