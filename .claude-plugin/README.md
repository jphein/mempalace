...
A Claude Code plugin that gives your AI a persistent memory system. Mine projects and conversations into a searchable palace backed by ChromaDB, with 39 MCP tools, auto-save hooks, and 5 guided skills.
...
The plugin automatically configures a local MCP server with 39 tools for storing, searching, and managing memories. No manual MCP setup is required -- `/mempalace:init` handles everything.
