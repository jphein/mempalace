...
|---|---|---|---|
| 1 | Sync upstream/develop through v3.9.0 (e8098348): 101 commits — durable config writes, strategy-aware candidate pools, BM25-under-threshold admission, search hub-forward, embeddinggemma batch override, cli_compatible search | — | [`TBD`](https://github.com/techempower-org/mempalace/commit/TBD) |
