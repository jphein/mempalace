...
- **[palace-daemon](https://github.com/rboarescu/palace-daemon)** (@rboarescu) — FastAPI gateway + MCP-over-HTTP proxy. Three asyncio semaphores (read / write / mine) with a dedicated mine lane so bulk imports can't starve interactive queries. Explicitly pins correctness floor at MemPalace ≥3.3.2. **This fork is integrating palace-daemon as its primary concurrency story** (replacing direct `mcp_server.py` ↔ palace access); see the "Multi-client coordination" note in Active Investigations for the integration shape. Solves the multi-client / multi-machine axis and the Windows `flock`-is-a-no-op gap.
...
|---|---|---|
| [#660](https://github.com/milla-jovovich/mempalace/pull/660) | CI green, awaiting review | L1 importance pre-filter |
| [#1005](https://github.com/milla-jovovich/mempalace/pull/1005) | CI green, Copilot + Dialectician acks, awaiting maintainer | Warnings + sqlite BM25 top-up — never silently return fewer results than scope contains |
| [#1024](https://github.com/milla-jovovich/mempalace/pull/1024) | CI green, qodo review addressed | Configurable `chunk_size` / `chunk_overlap` / `min_chunk_size` |
| [#1086](https://github.com/milla-jovovich/mempalace/pull/1086) | CI green, awaiting review | `mempalace export` CLI wrapper for `export_palace()` |
| [#1087](https://github.com/milla-jovovich/mempalace/pull/1087) | CI green, awaiting review | `mempalace purge --wing/--room` — destructive drawer removal with HNSW ghost handling |
| [#1094](https://github.com/milla-jovovich/mempalace/pull/1094) | CI green, awaiting review | Coerce `None` metadatas to `{}` at `ChromaCollection` boundary (closes [#1020](https://github.com/MemPalace/mempalace/issues/1020)) |
| [#1142](https://github.com/milla-jovovich/mempalace/pull/1142) | CI green, @bensig accepted 2026-04-23 | `docs/RELEASING.md` with `mempalace-mcp` pre-release grep (fulfills [#1093](https://github.com/MemPalace/mempalace/issues/1093)'s release-checklist proposal) |
| [#1171](https://github.com/milla-jovovich/mempalace/pull/1171) | CI green, awaiting review | Cross-process write lock at `ChromaCollection` adapter — prevents HNSW corruption from concurrent MCP servers + mine subprocesses |
| [#1173](https://github.com/milla-jovovich/mempalace/pull/1173) | CI green, awaiting review | Call `quarantine_stale_hnsw()` in `make_client()`; lower threshold 3600→300s (complementary to [#1062](https://github.com/MemPalace/mempalace/pull/1062)) |
| [#1177](https://github.com/milla-jovovich/mempalace/pull/1177) | CI green, awaiting review | `.blob_seq_ids_migrated` marker guard — skip `sqlite3.connect()` on already-migrated palaces (closes [#1090](https://github.com/MemPalace/mempalace/issues/1090)) |

Merged since v3.3.1:
- [v3.3.2](https://github.com/MemPalace/mempalace/releases/tag/v3.3.2) (2026-04-21): [#681](https://github.com/milla-jovovich/mempalace/pull/681), [#1000](https://github.com/milla-jovovich/mempalace/pull/1000), [#1023](https://github.com/milla-jovovich/mempalace/pull/1023)
- 2026-04-22: [#661](https://github.com/milla-jovovich/mempalace/pull/661), [#673](https://github.com/milla-jovovich/mempalace/pull/673), [#1021](https://github.com/milla-jovovich/mempalace/pull/1021), [#851](https://github.com/milla-jovovich/mempalace/pull/851) (upstream; also fixes #850, #1015)
- 2026-04-23: [#659](https://github.com/milla-jovovich/mempalace/pull/659)
- [v3.3.3](https://github.com/MemPalace/mempalace/releases/tag/v3.3.3) (2026-04-24): [#942](https://github.com/milla-jovovich/mempalace/pull/942), [#833](https://github.com/milla-jovovich/mempalace/pull/833), [#1097](https://github.com/milla-jovovich/mempalace/pull/1097), [#1145](https://github.com/milla-jovovich/mempalace/pull/1145), [#1147](https://github.com/milla-jovovich/mempalace/pull/1147) (follow-ups to #659), [#1148](https://github.com/milla-jovovich/mempalace/pull/1148) / [#1150](https://github.com/milla-jovovich/mempalace/pull/1150) / [#1157](https://github.com/milla-jovovich/mempalace/pull/1157) (entity-detection overhaul via @igorls's [#1175](https://github.com/milla-jovovich/mempalace/pull/1175) stacked-PR rescue), [#1166](https://github.com/milla-jovovich/mempalace/pull/1166) (palace-path env var security), [#340](https://github.com/milla-jovovich/mempalace/pull/340) / [#1093](https://github.com/milla-jovovich/mempalace/pull/1093) (mempalace-mcp install regression)
- Earlier: [#999](https://github.com/milla-jovovich/mempalace/pull/999) (2026-04-18)
