...
[![version-shield](https://img.shields.io/badge/version-3.4.0-4dc9f6?style=flat-square&labelColor=0a0e14)](https://github.com/techempower-org/mempalace/releases) [![upstream-shield](https://img.shields.io/badge/upstream-3.4.0-7dd8f8?style=flat-square&labelColor=0a0e14)](https://github.com/MemPalace/mempalace/releases)
...
A verbatim-first local AI memory system. This fork tracks `upstream/develop` through the v3.4.0 sync (2026-06-11, commit `2ec4bae`) and runs in production on a **409K+ drawer Postgres + pgvector + Apache AGE palace** behind [palace-daemon](https://github.com/techempower-org/palace-daemon). It carries ~621 fork-ahead commits that compose with — not replace — bensig's release direction; the v3.3.5 release (2026-05-10) includes our co-authored `_get_collection` retry-once via upstream #1377. 4282 tests pass on `main`.
